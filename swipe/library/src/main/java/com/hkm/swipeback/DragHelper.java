...
/**
 * DragHelper is a utility class for writing custom ViewGroups. It offers a
...
public class DragHelper {
    ...
    /**
     * A Callback is used as a communication channel with the DragHelper
     ...
     * the DragHelper with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the DragHelper will enter
         ...
         * place and the DragHelper will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * DragHelper may call this method multiple times for the same view
    ...
    /**
     * Apps should use DragHelper.create() to get a new instance. This will
     ...
     * @param forParent Parent view to monitor
     */
    private DragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
     ...
     * (to the best of the DragHelper's knowledge).
     * <p>
     ...
     * {@link me.imid.swipebacklayout.lib.DragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
